...
import com.udemy.projemanag.adapters.MemberListItemsAdapter
...
class MembersActivity : BaseActivity() {
    ...
    //  (Step 3: Create a global variable for Board Details.)
    // A global variable for Board Details.
    private lateinit var mBoardDetails: Board

    //  (Step 1: A global variable for Users List.)
    // A global variable for Assigned Members List.
    private lateinit var mAssignedMembersList:ArrayList<User>
    //  (Step 3: Declare a global variable for notifying any changes done or not.)
    ...
    /**
     *  (Step 3: Here we will get the result of the member if it found in the database.)
     */
    fun memberDetails(user: User) {
        //  (Step 6: Here add the user id to the existing assigned members list of the board.)
        mBoardDetails.assignedTo.add(user.id)

        //  (Step 9: Finally assign the member to the board.)
    ...
    fun memberAssignSuccess(user: User) {
        ...
        // (Step 4: Here the list is updated so change the global variable which we have declared for notifying changes.)
        anyChangesDone = true
    ...
    // (Step 5: Send the result to the base activity onBackPressed.)
