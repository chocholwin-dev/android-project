...
import com.udemy.projemanag.models.SelectedMembers
...
open class CardListItemsAdapter(
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (holder is MyViewHolder) {
            //  (Step 3: As we have already have a View Item for label color so make it visible and set the selected label color.)
            // START
            ...
            // (Step 3: Now with use of public list of Assigned members detail List populate the recyclerView for Assigned Members.)
            // START
            ...
            //  (Step 7: Set a click listener to the card item view.)
