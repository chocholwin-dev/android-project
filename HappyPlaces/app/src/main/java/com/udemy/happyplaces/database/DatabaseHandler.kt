...
//  (Step 3 : Creating a database handler class for local database operations like creating a table and inserting a Happy Place Detail.)
// START
...
class DatabaseHandler(context: Context):
    ...
    //  (Step 4 : After Creating a database handler class. Let us create an function to insert a happy place detail to respective table.)
    // START
    /**
    ...
    fun updateHappyPlace(happyPlace: HappyPlaceModel): Int {
        ...
        // Updating Row
        val success =
            db.update(TABLE_HAPPY_PLACE, contentValues,
