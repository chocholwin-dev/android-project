...
class AddHappyPlaceActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        dateSetListener =
            DatePickerDialog.OnDateSetListener { view, year, monthOfYear, dayOfMonth ->
                ...
                // (Step 9 : Called a function as updateDateInView where after selecting a date from date picker is populated in the UI component.)
                // START
                updateDateInView()
                // END
            }
    ...
    // (Step 5 : This is a override method after extending the onclick listener interface.)
    // START
    override fun onClick(v: View?) {
        when (v!!.id) {
            // (Step 7 : Launching the datepicker dialog on click of date edittext.)
            // START
            R.id.et_date -> {
                DatePickerDialog(
            ...
            R.id.tv_add_image -> {
                ...
                pictureDialog.setItems(pictureDialogItems) { dialog, which ->
                    when (which) {
                        ...
                        1 -> takePhotoFromCamera() //  (Step 6: Call the camera selection method over here.)
                    }
                }
                pictureDialog.show()
            }
            //  (Step 1 : Performing a click event on btn_save. And validating and saving the details in the local database.)
            // START
            R.id.btn_save -> {
    ...
    // (Step 8 : Created a function as updateDateInView where after selecting a date from date picker is populated in the UI component.)
    // START
    /**
                ...
                override fun onPermissionsChecked(report: MultiplePermissionsReport?) {
                    ...
                    if (report!!.areAllPermissionsGranted()) {
                        ...
                        Toast.makeText(applicationContext, "Permission granted", Toast.LENGTH_SHORT)
                            .show()
                        // (Step 1 : Adding an image selection code here from Gallery or phone storage.)
                        // START
    ...
    // (Step 3 : Receive the result of GALLERY and CAMERA.)
    // START
    /**
            ...
            if (requestCode == GALLERY) {
                if (data != null) {
                    ...
                    try {
                        ...
                        //  (Step 3 : Saving an image which is selected from GALLERY. And printed the path in logcat.)
                        // START
                ...
                //  (Step 7: Camera result will be received here.)
            } else if (requestCode == CAMERA) {
                // Bitmap from camera
                val thumbnail: Bitmap = data!!.extras!!.get("data") as Bitmap

                //  (Step 4 : Saving an image which is selected from CAMERA. And printed the path in logcat.)
                // START
    ...
    //  (Step 2 : Creating a method to save a copy of an selected image to internal storage for use of Happy Places App.)
    // START
    /**
    ...
    companion object {
        // (Step 2 : Create a variable for GALLERY Selection which will be later used in the onActivityResult method.)
        // START
        private const val GALLERY = 1
        // END

        // (Step 5 : Create a variable for CAMERA Selection which will be later used in the onActivityResult method.)
        // START
        private const val CAMERA = 2

        // (Step 1 : Creating an cont variable to use for Directory name for copying the selected image.)
        // START
